...
(function() {
    ...
    /* @ngInject */
    function SolicitarGiroCtrl($scope, $ionicLoading, $stateParams, geoLocationService,
                                  solicitudVehiculoService, mostrarAlert) {
        var vm = this;
        vm.giro = true;
        vm.ciudades = [];
        vm.solicitud= {};
